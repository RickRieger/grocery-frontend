...
export class Grocery extends Component {
  ...
  render() {
    ...
    return (
      ...
      <div id = "container">
      <div id="app">
        <div id="header"><h1>Grocery List</h1><p></p></div>
        <div id = "input_field">
          {this.state.canEdit ? (
          <input 
         ...
         onClick = {() => this.sortByDate("desc")}
         >newest-to-oldest</button>
         <button 
         className ="sorting-buttons"
         onClick = {() => this.sortByDate("asc")}
         >oldest-to-newest</button>
         <button 
         className ="sorting-buttons"
         onClick = {() => this.sortByPurchased("true")}
         >purchased</button>
         <button 
         className ="sorting-buttons"
         onClick = {() => this.sortByPurchased("false")}
